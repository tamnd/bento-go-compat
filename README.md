...
| `slices/struct_args` | a bento array of objects crossing into a Go `[]struct` argument, over integer and mixed string/number/boolean fields, the inverse of `slices/struct_boxes` |
